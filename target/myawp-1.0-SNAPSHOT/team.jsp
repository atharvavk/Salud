    ...
    <div class="container my-5">
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="team-member bb"><img class="rounded-circle " src="team/assets/img/team/ATHARVA.jpeg">
                            <h4><strong>Atharav Kulkarni</strong></h4>
                            <p>BT18CSE074</p>
                    ...
                    <div class="col-sm-4">
                        <div class="team-member"><img class="rounded-circle " src="./team/assets/img/team/RISHABH.jpeg">
                            <h4><strong>Rishabh Agrawal</strong></h4>
                            <p >BT18CSE054</p>
                            <ul class="list-inline social-buttons">
                                <li class="list-inline-item"><a href="#"><i class="fa fa-twitter"></i></a></li>
                                <li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
