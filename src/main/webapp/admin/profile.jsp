                    ...
                    <div class="row mb-3">
                        <div class="col-lg-8">
                            <div class="card shadow mb-3">
                                ...
                                <div class="card-body">
                                    <!--done validation-->
                                    <form method="get" id="usersettings" onsubmit="return validateUserForm()">
                                        <div class="form-row">
                                            <div class="col">
                                                <div class="form-group"><label for="number"><strong>Mobile
                                                            Number</strong></label><input class="form-control"
                                                        type="number" placeholder="8888-888-888" name="number"></div>
                                            </div>
                                            <div class="col">
                                        ...
                                        <div class="form-group"><button class="btn btn-primary btn-sm" type="submit"
                                                name='submit' id='usersubmit'>Save Settings</button>
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    <!-- validation done -->
                                    <form method="get" id="contactsettings" onsubmit="return validateContactForm()">
                                        ...
                                        <div class="form-group"><button class="btn btn-primary btn-sm"
                                            ...
                                            <span class="mx-4 text-danger" id='contacterror'></span>
                                        </div>
                                    </form>
                                </div>
                            </div>
